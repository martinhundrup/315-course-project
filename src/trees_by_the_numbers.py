...
#allData["COVID Cases"] = allData["COVID Cases"].round()
#allData[
#    "COVID Cases"
#         ] = allData[
#   "COVID Cases"
...
bins = [0,allData["COVID Cases"].quantile(0.30),allData["COVID Cases"].quantile(0.60),allData["COVID Cases"].quantile(0.9),allData["COVID Cases"].max()]
print(bins)
...
X = allData.drop(columns = ["COVID Cases","COVID Deaths"])
